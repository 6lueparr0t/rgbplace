"use strict";var onUnload=function(){event.returnValue=1},__URL__=window.location.hostname+window.location.pathname,__URL_ARRAY__=__URL__.split("/");window.addEventListener("dragover",function(){event.preventDefault()}),window.addEventListener("drop",function(){event.preventDefault()}),document.querySelector("body").addEventListener("click",function(a){var b=a.target;if(-1==b.className.search("menu")&&-1==b.className.search("status")&&"I"!=b.nodeName){var c=document.querySelectorAll("input[class='menu']");[].filter.call(c,function(a){a.checked=!1})}});
...
'use strict';function redirect(a){location.replace('/'+__URL_ARRAY__[1]+'/'+__URL_ARRAY__[2]+'/'+a)}function back(){location.replace(document.referrer)}
