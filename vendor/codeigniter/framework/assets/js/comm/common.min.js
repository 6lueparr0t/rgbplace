...
function httpRequest(a,b,c,d,e=null){let f=new XMLHttpRequest;f.open(a,b,!0),f.onload=function(){if(200<=this.status&&400>this.status){let a=JSON.parse(this.response);d(a)}},f.onprogress=function(){},f.onerror=function(){e()},f.send(c)}
