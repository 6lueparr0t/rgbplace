...
'use strict';var place=document.querySelector('#status-place'),type=document.querySelector('#status-type'),num=document.querySelector('#status-num'),act=document.querySelector('#status-act');2<URL_ARR.length?(document.querySelector('#type-act-default').selected=!0,document.querySelector('#type-'+URL_ARR[2]).selected=!0,document.querySelector('#type-num').selected=!0):document.querySelector('#status-type').selectedIndex=0;function goToURL(){var a='';a='/'+place.innerHTML+'/'+type.value+'/'+this,'#'===type.value&&(a='/'+place.innerHTML),window.location.href=a}type.addEventListener('change',goToURL.bind('list')),num.addEventListener('change',goToURL.bind('list')),act.addEventListener('change',goToURL.bind(URL_ARR[3]));