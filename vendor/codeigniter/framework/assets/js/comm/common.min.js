...
'use strict';var type=document.querySelector('#status-type'),place=document.querySelector('#status-place');type&&place&&type.addEventListener('change',function(){var a='';'#'===type.value&&(a='/'+place.innerHTML),a='/'+place.innerHTML+'/'+type.value+'/list',window.location.href=a});
