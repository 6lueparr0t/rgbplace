...
"use strict";var postSearchBtn=document.querySelector("#search-button"),postSearchInput=document.querySelector("#search-input");function postSearch(a){var b=[];b.title=document.querySelector("#search-mode-title").checked,b.content=document.querySelector("#search-mode-content").checked,b.reply=document.querySelector("#search-mode-reply").checked,b.name=document.querySelector("#search-mode-name").checked,b.keyword=document.querySelector("#search-mode-keyword").checked,b.date=document.querySelector("#search-mode-date").checked;var c="";for(var d in b)b[d]&&(c+=d+"="+a+"&");console.log(c),redirect("list?"+c)}postSearchBtn&&postSearchBtn.addEventListener("click",function(){postSearch(postSearchInput.value)}),postSearchInput&&postSearchInput.addEventListener("keydown",function(a){"13"==a.keyCode&&postSearch(this.value)});