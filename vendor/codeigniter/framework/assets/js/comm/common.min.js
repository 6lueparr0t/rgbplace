...
function ajaxHandler(a,b,c=null){let d=new XMLHttpRequest;d.open(a,b,!0),d.onload=function(){200<=this.status&&400>this.status&&(c=JSON.parse(this.response))},d.onprogress=function(){},d.onerror=function(){},d.send(c)}
