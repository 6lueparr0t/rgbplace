...
"use strict";var searchButtonPost=document.querySelector("#search-button"),searchInputPost=document.querySelector("#search-input");function postSearch(a){console.log(a.value)}searchButtonPost&&searchButtonPost.addEventListener("click",function(){postSearch(searchInputPost)}),searchInputPost&&searchInputPost.addEventListener("keydown",function(a){"13"==a.keyCode&&postSearch(this)});
