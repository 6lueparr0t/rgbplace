...
'use strict';var num=document.querySelector('#status-num'),type=document.querySelector('#status-type'),place=document.querySelector('#status-place');2<URL_ARR.length?document.querySelector('#type-'+URL_ARR[2]).selected=!0:document.querySelector('#status-type').selectedIndex=0;function goToList(){var a='';'#'===type.value&&(a='/'+place.innerHTML),a='/'+place.innerHTML+'/'+type.value+'/list',window.location.href=a}type.addEventListener('change',goToList),num.addEventListener('change',goToList);