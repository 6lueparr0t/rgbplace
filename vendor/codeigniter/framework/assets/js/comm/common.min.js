"use strict";let onUnload=function(){event.returnValue=1};window.addEventListener("dragover",function(){event.preventDefault()}),window.addEventListener("drop",function(){event.preventDefault()}),document.querySelector("body").addEventListener("click",function(a){let b=a.target;-1==b.className.search("menu")&&-1==b.className.search("status")&&"I"!=b.nodeName&&(document.querySelector(".menu").checked=!1)});
