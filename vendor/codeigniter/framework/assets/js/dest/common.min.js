var signin=document.querySelector("#sign-in"),signup=document.querySelector("#sign-up"),signup_conf=document.querySelector("#sign-up input[name='conf']");signin&&signin.addEventListener("submit",function(){event.preventDefault(),signInCheck(signin)}),signup&&signup.addEventListener("submit",function(){event.preventDefault(),signUpCheck(signup)}),signup_conf&&signup_conf.addEventListener("input",this.check);
...
function signUpCheck(e){var t=new FormData(e),n=new XMLHttpRequest,o="";n.open("post","/sign/up/check",!0),n.onload=function(){this.status>=200&&this.status<400&&(o=JSON.parse(this.response),o.valid?e.submit():alert(o.msg))},n.onprogress=function(){console.log("event.lengthComputable:"+event.lengthComputable),console.log("event.loaded:"+event.loaded),console.log("event.total:"+event.total)},n.onerror=function(){},n.send(t)}