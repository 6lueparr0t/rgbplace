...
";
    ...
    {
        return new Twig_Source("", "database/structure/check_all_tables.twig", "/usr/local/var/www/vendor/codeigniter/framework/database/templates/database/structure/check_all_tables.twig");
    }
}
