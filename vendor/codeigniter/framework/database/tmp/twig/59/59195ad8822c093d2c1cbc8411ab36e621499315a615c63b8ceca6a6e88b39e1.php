...
";
    ...
    {
        return new Twig_Source("", "columns_definitions/table_fields_definitions.twig", "/usr/local/var/www/vendor/codeigniter/framework/database/templates/columns_definitions/table_fields_definitions.twig");
    }
}
