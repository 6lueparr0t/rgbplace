...
";
    ...
    {
        return new Twig_Source("", "table/search/fields_table.twig", "/usr/local/var/www/vendor/codeigniter/framework/database/templates/table/search/fields_table.twig");
    }
}
