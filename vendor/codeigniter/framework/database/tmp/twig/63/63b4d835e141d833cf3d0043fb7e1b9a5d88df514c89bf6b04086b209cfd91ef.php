...
";
    ...
    {
        return new Twig_Source("", "database/structure/favorite_anchor.twig", "/usr/local/var/www/vendor/codeigniter/framework/database/templates/database/structure/favorite_anchor.twig");
    }
}
