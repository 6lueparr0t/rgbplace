...
";
    ...
    {
        return new Twig_Source("", "columns_definitions/move_column.twig", "/usr/local/var/www/vendor/codeigniter/framework/database/templates/columns_definitions/move_column.twig");
    }
}
