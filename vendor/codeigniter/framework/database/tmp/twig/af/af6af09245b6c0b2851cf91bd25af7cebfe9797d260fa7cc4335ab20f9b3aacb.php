...
";
    ...
    {
        return new Twig_Source("", "table/insert/continue_insertion_form.twig", "/usr/local/var/www/vendor/codeigniter/framework/database/templates/table/insert/continue_insertion_form.twig");
    }
}
