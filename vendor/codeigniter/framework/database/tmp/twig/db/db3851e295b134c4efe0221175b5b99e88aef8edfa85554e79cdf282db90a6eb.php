...
";
    ...
    {
        return new Twig_Source("", "columns_definitions/column_attribute.twig", "/usr/local/var/www/vendor/codeigniter/framework/database/templates/columns_definitions/column_attribute.twig");
    }
}
